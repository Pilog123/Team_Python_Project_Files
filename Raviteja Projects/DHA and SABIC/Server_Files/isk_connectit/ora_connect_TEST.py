...
class DatabaseConnection:
    ...
    def accessNameValidation(self) -> str:
        ...
        with open(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/isk_connectit/jython_DB.properties', 'r') as fp:
            countdata = 0
            fdata = fp.readlines()
            for i in fdata:
    ...
    def getDBProperties(self):
        with open(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/isk_connectit/jython_DB.properties', 'rb') as fp:
            db_dict = {}
