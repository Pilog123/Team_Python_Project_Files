...
# DHA_App = FastAPI(title="DHA Service")
...
def DHA_Caller(DHA_SOURCE_DATASET, req_dct):
    # BATCH_ID = 'B00000000001187'
    BATCH_ID = req_dct['BATCH_ID']

    DHA_SOURCE_DATASET.rename(columns={'LONG_TEXT': 'LONG_DESCRIPTION', 'SHORT_TEXT': 'SHORT_DESCRIPTION', 'RECORD_NO': 'MATERIAL'}, inplace=True)
    # DHA_SOURCE_DATASET = DHA_SOURCE_DATASET[['MATERIAL', 'LONG_DESCRIPTION', 'SHORT_DESCRIPTION', 'UOM', 'MATERIAL_TYPE', 'MATERIAL_GROUP']]
    DHA_SOURCE_DATASET = DHA_SOURCE_DATASET[['MATERIAL', 'LONG_DESCRIPTION', 'SHORT_DESCRIPTION', 'UOM']]
    DHA_SOURCE_DATASET.fillna('', inplace=True)
    print("+++++++",DHA_SOURCE_DATASET)
    ...
    my_image = doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/pi.jpg', width=Inches(2.79),height=Inches(0.90))
    ...
    doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/METHODOLOGY.png', width=Inches(6), height=Inches(4))
    ...
    doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/data_quality_standards_3.png', width=Inches(6), height=Inches(3.2))
    ...
    run.add_picture(r"/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/pi.jpg", width=Inches(1))
    ...
    # data = pd.read_excel(r'C:\Users\Administrator\PythonDeployment\DHA and SABIC\Server Files\Excel_Source\new_data.xlsx')
    data = DHA_SOURCE_DATASET
    ...
    fig1.write_image(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/figA.jpeg',width=9,height=8)
    doc.add_paragraph('\n')
    doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/figA.jpeg', width=Inches(6), height=Inches(3))
    ...
    try:
        ...
        fig22 = px.pie(LEN, values='Count', names='Criteria',
                       color_discrete_sequence=["rgb(24, 100, 171)", "rgb(253, 126, 20)", "rgb(250,128,114)",
                                                "rgb(0, 113, 197)", "rgb(255,0,255)", "rgb(148,0,211)",
                                                "rgb(210,105,30)", "rgb(0,255,255)", "rgb(255,127,80)", "rgb(128,0,0)"])
        ...
        for i in range(LEN.shape[0]):
            ...
            for j in range(LEN.shape[-1]):
                ...
                p.alignment=WD_TABLE_ALIGNMENT.CENTER
        fig22.write_image(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref.jpeg')
        doc.add_paragraph('\n')
        doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref.jpeg',width=Inches(6), height=Inches(3))
    except:
    ...
    try:
        part_prefix_df = pd.read_excel(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/Excel_Source/V10_ORIG.xls')
        ...
        fig223 = px.pie(LEN, values='Count', names='Criteria',
                        color_discrete_sequence=["rgb(24, 100, 171)", "rgb(253, 126, 20)", "rgb(250,128,114)",
                                                 "rgb(0, 113, 197)", "rgb(255,0,255)", "rgb(148,0,211)",
                                                 "rgb(210,105,30)", "rgb(0,255,255)", "rgb(255,127,80)",
                                                 "rgb(128,0,0)"])
        ...
        for i in range(LEN.shape[0]):
            ...
            for j in range(LEN.shape[-1]):
                ...
                p=row[j].add_paragraph(str(LEN.values[i,j]))
                p.alignment=WD_TABLE_ALIGNMENT.CENTER
        fig223.write_image(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref2.jpeg')
        doc.add_paragraph('\n')
        doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref2.jpeg',width=Inches(6), height=Inches(3))
    except:
        doc.add_paragraph('No data available')
    ...
    try:
        ...
        sample_df = pd.read_excel(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/Excel_Source/new_data.xlsx')
        sample_df = DHA_SOURCE_DATASET
        # sample_df = sample_df[:1500]
        # sample_df = pd.read_sql("select * from O_RECORD_HEALTH_ASSESSMENT where BATCH_ID = '{}' ".format(BATCH_ID), conn)
        # sample_df = sample_df.drop(columns=["UOM", "MATERIAL_TYPE", "MATERIAL_GROUP"])
        ...
        REF.to_excel(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/Excel_Source/DHA_REFERENCE_NUMBERS.xlsx')
        print("44444444444455555555555555555")
        ...
        total_dup = total_dup[['MATERIAL','LONG_DESCRIPTION','Reference Type',
                               'Total_Reference_Numbers','BATCH_ID','TABLE_TYPE','VAL_SEQUENCE', 'INSERT_BY']]
        ...
        for i in range(LEN.shape[0]):
            ...
            for j in range(LEN.shape[-1]):
                ...
                p=row[j].add_paragraph(str(LEN.values[i,j]))
                p.alignment=WD_TABLE_ALIGNMENT.CENTER
        fig223.write_image(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref9.jpeg')
        # except:
        #     doc.add_paragraph('')
        ...
        hyperlink = add_hyperlink(p, 'http://apihub.pilogcloud.com:6651/user_down/Reference_Details/{}/{}/Reference Details_{}'.format(BATCH_ID, insert_time, format(datetime.now().replace(microsecond=0))), 'click here', '0000FF', True)

        ###########################################################################################
        doc.add_paragraph('\n')
        doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref9.jpeg',width=Inches(6), height=Inches(3))
    except:
        doc.add_paragraph('No data available')
    ...
    # sample_df = pd.read_sql("select * from O_RECORD_HEALTH_ASSESSMENT where BATCH_ID = '{}' ".format(BATCH_ID), conn)
    # sample_df = sample_df.drop(columns=["UOM", "MATERIAL_TYPE", "MATERIAL_GROUP","SHORT_DESCRIPTION"])
    ...
    # rgb_list = ["1864ab", "fd7e14", "FA8072", "EEE8AA", "87CEEB", "AFEEEE", "E0FFFF", "ADD8E6", "87CEEB", "5F9EA0",
    #             "B0E0E6", "AFEEEE", "40E0D0", "66CDAA", "F08080", "FFA07A", "EE82EE", "FFE4C4", "FFFFE0", "DCDCDC",
    #             "F8F8FF"]
    part_prefix_df = pd.read_excel(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/Excel_Source/V10_ORIG.xls')
    part_prefix_df = part_prefix_df.fillna('')
    ...
    # sample2["Reference_Number"] = sample2.Reference_Number.str.replace(r'([\w\W]{1,4})', '')
...
###############################################################################
        # doc.add_paragraph('\n')
        # doc.add_picture(r'fig_ref1_.jpeg', width=Inches(6), height=Inches(3))
############################################################################################3
    try:
        ...
        SD_Length_15_30 = np.sum(length1['Count'].isin(range(15,30)))
        SD_Length_30_40 = np.sum(length1['Count'].isin(range(30,41)))
        ...
        fig22.update_layout(  title={'text':'Report on Short Description Length','y':0.95, 'x':0.5,'xanchor':'center','yanchor':'top'},
                    ...
                    yaxis=dict(
                            ...
                            uniformtext_minsize=20, uniformtext_mode='hide')
        config={'displaylogo':False}
        fig22.write_image(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig36.jpeg')
        ...
        for i in range(LEN.shape[0]):
            ...
            for j in range(LEN.shape[-1]):
                ...
                p.alignment=WD_TABLE_ALIGNMENT.CENTER
        doc.add_paragraph('\n')
        doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig36.jpeg',width=Inches(6), height=Inches(3))
    except:
        doc.add_paragraph('No data available')
        # doc.add_paragraph('\n')
    ...
    #
    #     doc.add_paragraph('\n')
    #     doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA and SABIC\Server Files\assests\fig36.jpeg',width=Inches(6), height=Inches(3))
    # except:
    #     doc.add_paragraph('No data available')
    ...
    try:
        ...
        fig222 = px.pie(phenom_ld_len_data_graph, values='Count', names='Criteria',
                        color_discrete_sequence=["rgb(24, 100, 171)", "rgb(253, 126, 20)", "rgb(250,128,114)",
                                                 "rgb(0, 113, 197)", "rgb(255,0,255)", "rgb(148,0,211)",
                                                 "rgb(210,105,30)", "rgb(0,255,255)", "rgb(255,127,80)",
                                                 "rgb(128,0,0)"])
        ...
        for i in range(phenom_ld_len_data.shape[0]):
            ...
            for j in range(phenom_ld_len_data.shape[-1]):
                ...
                p.alignment=WD_TABLE_ALIGNMENT.CENTER
        fig222.write_image(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref_.jpeg')
        doc.add_paragraph('\n')
        doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref_.jpeg',width=Inches(6), height=Inches(3))
    except:
        doc.add_paragraph('No data available')
    ...
    try:
        ...
        fig22 = px.pie(LEN, values='Total Number of Records', names='Criteria',
                       color_discrete_sequence=["rgb(24, 100, 171)", "rgb(253, 126, 20)", "rgb(250,128,114)",
                                                "rgb(0, 113, 197)", "rgb(255,0,255)", "rgb(148,0,211)",
                                                "rgb(210,105,30)", "rgb(0,255,255)", "rgb(255,127,80)", "rgb(128,0,0)"])
        fig22.update_traces(textposition='inside',textinfo='value')
        ...
        for i in range(LEN.shape[0]):
            ...
            for j in range(LEN.shape[-1]):
                ...
                p=row[j].add_paragraph(str(LEN.values[i,j]))
                p.alignment=WD_TABLE_ALIGNMENT.CENTER
        fig22.write_image(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref_count.jpeg')
        doc.add_paragraph('\n')
        doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/fig_ref_count.jpeg',width=Inches(6), height=Inches(3))
    except:
        doc.add_paragraph('No data available')
    ...
    try:
        # sample_df = pd.read_excel(r'C:\Users\Administrator\Desktop\all files\keshav_sir_files\DHA3.xlsx')
        # sample_df = pd.read_excel(r'C:\Users\Administrator\PythonDeployment\DHA and SABIC\Server Files\Excel_Source\new_data.xlsx')
        sample_df = DHA_SOURCE_DATASET
        # sample_df = sample_df[:1500]
        # sample_df = pd.read_sql("select * from O_RECORD_HEALTH_ASSESSMENT where BATCH_ID = '{}' ".format(BATCH_ID), conn)
        # sample_df = sample_df.drop(columns=["UOM", "MATERIAL_TYPE", "MATERIAL_GROUP","SHORT_DESCRIPTION"])
        ...
        # rgb_list = ["1864ab", "fd7e14", "FA8072", "EEE8AA", "7FFFD4", "696969", "E0FFFF", "ADD8E6", "87CEEB", "5F9EA0",
        #             "B0E0E6", "AFEEEE", "40E0D0", "66CDAA", "F08080", "FFA07A", "EE82EE", "FFE4C4", "FFFFE0", "DCDCDC",
        #             "F8F8FF"]
        ...
        hyperlink = add_hyperlink(p, 'http://apihub.pilogcloud.com:6651/user_down/inconsistencies_Prefixes/{}/{}/Inconsistencies Prefixes {}'.format(BATCH_ID, insert_time, format(datetime.now().replace(microsecond=0))), 'click here', '0000FF', True)
    ...
    try:
        ...
        hyperlink = add_hyperlink(p, 'http://apihub.pilogcloud.com:6651/user_down/UOM_Prefixes/{}/{}/UOM Prefixes {}'.format(BATCH_ID, insert_time, format(datetime.now().replace(microsecond=0))), 'click here', '0000FF', True)
        ###########################################################################################
    ...
    try:
        ...
        # sample12.to_excel('sample12_L.xlsx')
        # print(sample12)
        ...
        hyperlink = add_hyperlink(p, 'http://apihub.pilogcloud.com:6651/user_down/inconsistencies/{}/{}/Inconsistencies {}'.format(BATCH_ID, insert_time, format(datetime.now().replace(microsecond=0))), 'click here', '0000FF', True)


        ###########################################################################################
    except:
        print('-'*50, 'EXPECT IN INconsistenis', '-'*50, '\n')
        doc.add_paragraph('No data available')
    ...
    try:
        ...
        sample14.to_excel(r'sample14.xlsx')
        ...
        hyperlink = add_hyperlink(p, 'http://apihub.pilogcloud.com:6651/user_down/non_standardized_uom/{}/{}/Non-Standardized UOMs {}'.format(BATCH_ID, insert_time, format(datetime.now().replace(microsecond=0))), 'click here', '0000FF', True)
    ...
    fig = px.pie(UOM1, values='Top10 Count', names='UOM',
                 color_discrete_sequence=["rgb(24, 100, 171)", "rgb(253, 126, 20)", "rgb(250,128,114)",
                                          "rgb(0, 113, 197)", "rgb(255,0,255)", "rgb(148,0,211)", "rgb(210,105,30)",
                                          "rgb(0,255,255)", "rgb(255,127,80)", "rgb(128,0,0)"])
    ...
    fig.write_image(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/Top10_UOM.png')
    doc.add_paragraph('\n')
    doc.add_picture(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/assests/Top10_UOM.png',width=Inches(6), height=Inches(3))
    # doc.add_page_break()
    ...
    # doc.save('DHA-19-10-21.docx')

    # convert_to_pdf_win('/home/python_user/DOC/assests/DHA-19-10-21.docx', '/home/python_user/DOC/assests/DHA_DOC_19-10.pdf')

    # return FileResponse('/home/python_user/DOC/assests/DHA_DOC_19-10.pdf')
    # doc_unq_name = format(datetime.now().replace(microsecond=0))
    doc.save(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/PDF Results/DHA_DOC2_08_07.docx')
    
    now = datetime.now()
    print('End time',now)

    #doc.save('Analysis_Data.docx', 'r')
    #convert("Analysis_Data.docx", "output.pdf")

    # convert_to_pdf('/home/python_user/DOC/assests/DHA_{}.docx'.format(doc_unq_name), '/home/python_user/DOC/assests')





    # convert_to_pdf_win(r'C:\Users\Administrator\PythonDeployment\DHA and SABIC\Server Files\PDF Results\DHA_DOC2.docx', 'C:\Users\Administrator\PythonDeployment\DHA and SABIC\Server Files\PDF Results\')




    convert_to_pdf_win(r'/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/PDF Results/DHA_DOC2.docx', '/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/PDF Results/')


    pdf_file = r"/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/PDF Results/DHA_DOC2.pdf"
    watermark = r"/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/PDF Results'/Wmark.pdf"
    # merged = r"C:\Users\Administrator\PythonDeployment\DHA and SABIC\Server Files\PDF Results\DHA_OUTPUT{}.pdf".format(rd.randint(100, 1000)/25)
    merged = "/root/Desktop/Team Python Deployment/Raviteja Projects/DHA and SABIC/Server_Files/PDF Results/DHA_OUTPUT_{}.pdf".format(str(format(datetime.now().replace(microsecond=0))).replace(' ', '_').replace(':', '-'))
