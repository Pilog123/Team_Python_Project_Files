...
def DHA_Caller(DHA_SOURCE_DATASET, req_dct):
    ...
    my_image = doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\pi.jpg', width=Inches(2.79),height=Inches(0.90))
    ...
    doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\METHODOLOGY.png', width=Inches(6), height=Inches(4))
    ...
    doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\data_quality_standards_3.png', width=Inches(6), height=Inches(3.2))
    ...
    run.add_picture(r"C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\pi.jpg", width=Inches(1))
    ...
    # data = pd.read_excel(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\Excel_Source\new_data.xlsx')
    ...
    fig1.write_image(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\figA.jpeg',width=9,height=8)
    doc.add_paragraph('\n')
    doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\figA.jpeg', width=Inches(6), height=Inches(3))
    ...
    for i in range(LEN.shape[0]):
        ...
        for j in range(LEN.shape[-1]):
            ...
            p.alignment=WD_TABLE_ALIGNMENT.CENTER
    fig22.write_image(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref.jpeg')
    doc.add_paragraph('\n')
    doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref.jpeg',width=Inches(6), height=Inches(3))
    ...
    part_prefix_df = pd.read_excel(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\Excel_Source\V10_ORIG.xls')
    ...
    for i in range(LEN.shape[0]):
        ...
        for j in range(LEN.shape[-1]):
            ...
            p=row[j].add_paragraph(str(LEN.values[i,j]))
            p.alignment=WD_TABLE_ALIGNMENT.CENTER
    fig223.write_image(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref2.jpeg')
    doc.add_paragraph('\n')
    doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref2.jpeg',width=Inches(6), height=Inches(3))
    ...
    sample_df = pd.read_excel(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\Excel_Source\new_data.xlsx')
    ...
    REF.to_excel(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\Excel_Source\DHA_REFERENCE_NUMBERS.xlsx')
    ...
    for i in range(LEN.shape[0]):
        ...
        for j in range(LEN.shape[-1]):
            ...
            p=row[j].add_paragraph(str(LEN.values[i,j]))
            p.alignment=WD_TABLE_ALIGNMENT.CENTER
    fig223.write_image(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref9.jpeg')
    # except:
    #     doc.add_paragraph('')
    ...
    hyperlink = add_hyperlink(p, 'http://apihub.piloggroup.com:6652/user_down/Reference_Details/{}/{}/Reference Details_{}'.format(BATCH_ID, insert_time, format(datetime.now().replace(microsecond=0))), 'click here', '0000FF', True)

    ###########################################################################################
    doc.add_paragraph('\n')
    doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref9.jpeg',width=Inches(6), height=Inches(3))
    ...
    ##################################################################################################################################################
    # sample2.to_excel(r'C:\Users\Administrator\Desktop\NOV\reference_data1.xlsx')
    print(sample2)
    ...
    sample2.rename(columns={'ReferenceNumber':'Reference Number'},inplace=True)

    # # thread 2
    # def potential_duplicates_wrt_manufacturer_part_number_2():
    #     def part_no_checker(description):
    #         container = []
    #         manufacture_part_df = part_prefix_df[part_prefix_df["V10_PART_PREFIX"] != "MANUFACTURER"]
    #         for i, row in manufacture_part_df.iterrows():
    ...
    #     sample_df_5 = sample_df[1].dropna(subset=["LONG_DESCRIPTION"])
    #     sample_df_5["Captured_part_no_list"] = sample_df_5["LONG_DESCRIPTION"].apply(lambda x: part_no_checker(x))
    #     sample_df_5 = sample_df_5.dropna(subset=["Captured_part_no_list"])
    #     sample_df_5_explode = sample_df_5.assign(ManufacturerPartNumber=sample_df_5.Captured_part_no_list).explode(
    #         'ManufacturerPartNumber')
    #     sample_df_5_explode.drop(columns=["Captured_part_no_list"], inplace=True)
    #     sample_df_5_explode["trimmed_part"] = sample_df_5_explode["ManufacturerPartNumber"].apply(lambda x: x.split("~")[1])
    #     sample_df_5_explode["ManufacturerPartNumber"] = sample_df_5_explode["ManufacturerPartNumber"].apply(lambda x: x.split("~")[0])
    #     sample_df_5_output = sample_df_5_explode[sample_df_5_explode.duplicated("trimmed_part", keep=False)]
    #     sample_df_5_output = sample_df_5_output.drop(columns=["trimmed_part"])
    #     sample_df_5_output = sample_df_5_output.sort_values(by=["ManufacturerPartNumber"])
    #     # sample_df_5_output.to_excel("potential_duplicates_wrt_manufacturer_part_number.xlsx")
    #     return sample_df_5_output
    # sample3 = potential_duplicates_wrt_manufacturer_part_number_2()
    # print("2222222222222222222222222222")
    # ####################################################################################
    # # def prefix_remove_1(x):      
    # #     source = x
    # #     for i in (range(part_prefix_df.shape[0])):
    # #         des = re.sub(str(part_prefix_df['ORIGINAL_PART_PREFIX'][i]),'',source)
    # #         source = des
    # #     return source
    # # sample3['ManufacturerPartNumber'] = sample3['ManufacturerPartNumber'].apply(lambda x:prefix_remove_1(x))
    # ########################################################################################        


    # # sample3['ManufacturerPartNumber'] = sample3['ManufacturerPartNumber'].apply(lambda x: x[0:-1])
    # unique_part_no2 = sample3["ManufacturerPartNumber"].unique().tolist()
    # sample3.rename(columns={'ManufacturerPartNumber':'Manufacturer Part Number'},inplace=True)

    # # thread 3
    # def potential_duplicates_wrt_manufacturer_part_number_3():
    #     def part_no_checker(description):
    #         container = []
    #         manufacture_part_df = part_prefix_df[part_prefix_df["V10_PART_PREFIX"] != "MANUFACTURER"]
    #         for i, row in manufacture_part_df.iterrows():
    #             cleaned_part_code = re.sub(":", "", row["ORIGINAL_PART_PREFIX"])
    #             cleaned_part_code = re.sub("\.", "\\.", cleaned_part_code)
    #             pat = re.compile(r"(\b[,;\s]?%s[:\-\s]{1,9}[a-zA-Z0-9]{1,40}[^,;\s]*)" % cleaned_part_code) # for 
    #             # pat = re.compile(r"(\b%s[^:]?:\s?[:;,]{0,9}[^,;:]*)" % cleaned_part_code)
    ...
    #     sample_df_5 = sample_df[2].dropna(subset=["LONG_DESCRIPTION"])
    #     sample_df_5["Captured_part_no_list"] = sample_df_5["LONG_DESCRIPTION"].apply(lambda x: part_no_checker(x))
    #     sample_df_5 = sample_df_5.dropna(subset=["Captured_part_no_list"])
    #     sample_df_5_explode = sample_df_5.assign(ManufacturerPartNumber=sample_df_5.Captured_part_no_list).explode(
    #         'ManufacturerPartNumber')
    ...
    # sample4 = potential_duplicates_wrt_manufacturer_part_number_3()
    # print('33333333333333')
    # #################################################################################
    # # def prefix_remove_2(x):      
    # #     source = x
    # #     for i in (range(part_prefix_df.shape[0])):
    # #         des = re.sub(part_prefix_df['ORIGINAL_PART_PREFIX'][i]),'',source)
    # #         source = des
    # #     return source
    # # sample4['ManufacturerPartNumber'] = sample4['ManufacturerPartNumber'].apply(lambda x:prefix_remove_2(x))
    # #####################################################################################        



    # # sample4['ManufacturerPartNumber'] = sample4['ManufacturerPartNumber'].apply(lambda x: x[0:-1])
    # unique_part_no3 = sample4["ManufacturerPartNumber"].unique().tolist()
    # sample4.rename(columns={'ManufacturerPartNumber':'Manufacturer Part Number'},inplace=True)

    # def main_task():
    #     # creating threads
    #     t1 = threading.Thread(target=potential_duplicates_wrt_manufacturer_part_number_1)
    #     t2 = threading.Thread(target=potential_duplicates_wrt_manufacturer_part_number_2)
    #     t3 = threading.Thread(target=potential_duplicates_wrt_manufacturer_part_number_3)
    ...
    # sample5 = pd.concat([sample2,sample3,sample4])
    # print("444444444444444")
    # unique_part_no = unique_part_no1 + unique_part_no2 + unique_part_no3

    li2 = list(sample2.index)
    sac=sample2.copy()
    ...
    for i in range(len(sac)):
        try:
            if sac["Reference Number"][i] != sac["Reference Number"][1+i]:
                cnt=cnt+1
                if cnt==5:
                    datasize=i
                    break
    ...
    fig22.update_layout(  title={'text':'Report on Short Description Length','y':0.95, 'x':0.5,'xanchor':'center','yanchor':'top'},
                ...
                yaxis=dict(
                        ...
                        uniformtext_minsize=20, uniformtext_mode='hide')
    config={'displaylogo':False}
    fig22.write_image(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig36.jpeg')
    ...
    doc.add_paragraph('\n')
    doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig36.jpeg',width=Inches(6), height=Inches(3))
    ...
    for i in range(phenom_ld_len_data.shape[0]):
        ...
        for j in range(phenom_ld_len_data.shape[-1]):
            ...
            p.alignment=WD_TABLE_ALIGNMENT.CENTER
    fig222.write_image(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref_.jpeg')
    doc.add_paragraph('\n')
    doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref_.jpeg',width=Inches(6), height=Inches(3))
    ...
    try:
        ...
        for i in range(LEN.shape[0]):
            ...
            for j in range(LEN.shape[-1]):
                ...
                p=row[j].add_paragraph(str(LEN.values[i,j]))
                p.alignment=WD_TABLE_ALIGNMENT.CENTER
        fig22.write_image(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref_count.jpeg')
        doc.add_paragraph('\n')
        doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\fig_ref_count.jpeg',width=Inches(6), height=Inches(3))
    except:
        doc.add_paragraph('')
    ...
    fig.write_image(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\Top10_UOM.png')
    doc.add_paragraph('\n')
    doc.add_picture(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\assests\Top10_UOM.png',width=Inches(6), height=Inches(3))
    # doc.add_page_break()
    ...
    doc.save(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\PDF Results\DHA_DOC2.docx')
    ...
    # convert_to_pdf_win(r'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\PDF Results\DHA_DOC2.docx', 'C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\PDF Results\')
    ...
    pdf_file = r"C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\PDF Results\DHA_DOC2.pdf"
    watermark = r"C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\PDF Results\Wmark.pdf"
    # merged = r"C:\Users\Administrator\PythonDeployment\DHA Preparation\Server Files\PDF Results\DHA_OUTPUT{}.pdf".format(rd.randint(100, 1000)/25)
    merged = "C:/Users/Administrator/PythonDeployment/DHA Preparation/Server Files/PDF Results/DHA_OUTPUT_{}.pdf".format(str(format(datetime.now().replace(microsecond=0))).replace(' ', '_').replace(':', '-'))
