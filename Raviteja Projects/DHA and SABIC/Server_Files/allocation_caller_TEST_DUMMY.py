...
allocationApp = FastAPI(title="DHA Allocation",
...
#         charallocation_dataset = CHAR_ALLOCATION_CHANGED.char_allocation(clause_df, prop_cndtn_df, char_data[:50], UOM, UOM1)
...
@allocationApp.get("/DHAA")
@allocationApp.post("/DHAA")
...
if __name__ == '__main__':
    uvicorn.run("allocation_caller_TEST_DUMMY:allocationApp", host='172.16.1.60', port=6648, log_level='info')
