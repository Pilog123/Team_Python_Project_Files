...
def class_allocation_func(source_DF):
    ...
    source_DF['CLASS_LAST_'] = source_DF[source_DF['FINAL_CLASS'].isnull() & source_DF['First_CLASS'].isnull() & source_DF['CLASS21'].isnull() &
    ...
    source_DF['NEW_CLASS'].fillna('No Object', inplace = True)
    source_DF.fillna('',inplace=True)
...
print(df[df['NEW_CLASS'] == 'No Object'])
# # print(df.head(50))
# # # print(df.tail(50))
