...
def char_allocation(clause_data,property_cndtn_data,class_data,UOM,UOM1):
    ...
    classData.rename(columns={'SPIR_NO':'MDRM','ITEM_DESC':'Long Description','OBJ_QUAL':'Class'},inplace=True)
...
# =============================================================================================================
    ...
    class_data_new['Prop_Val'] = class_data_new.apply(lambda x: re.sub(r'^[\,\:]{1,2}|[\,\:]{1,2}$','',x['Prop_Val']), axis = 1)
...
# ==============================================================================================================================
    ...
    final_data['Prop_Val'] = final_data.apply(lambda x: re.sub(r'^[\.\,\:\-\/()+]{1,3}|[\.\,\:\-\/()+]{1,3}$','',x['Prop_Val']), axis = 1)
    ...
    # print(final_df)
    """RECORD_NO, REGION, LOCALE, CLASS_CONCEPT_ID, PROPERTY_CONCEPT_ID,
     PROPERTY_NAME,
     DATA_TYPE, REQUIRED_FLAG, STXT_FLAG, LTXT_FLAG,
      CREATE_DATE, CREATE_BY, EDIT_DATE, EDIT_BY, AUDIT_ID"""

    final_data['REGION'] = 'IN'
    final_data['LOCALE'] = 'en_US'
    final_data['CLASS_CONCEPT_ID'] = 'UNKNOWN'
    final_data['PROPERTY_CONCEPT_ID'] = 'UNKNOWN'
    final_data['REQUIRED_FLAG'] = 'Y'
    final_data['STXT_FLAG'] = 'Y'
    final_data['LTXT_FLAG'] = 'Y'
    final_data['CREATE_BY'] = 'DXP'
    final_data['EDIT_BY'] = 'DXP'
