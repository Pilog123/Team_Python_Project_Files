...
def char_allocation():
    ...
    prop_cndtn_df = pd.read_excel("Is_properties_condition_working_21.03.22_rev.xls", 'Sheet2').iloc[:,:9]
    cls_df = pd.read_excel("DH_RUN1.xlsx")
...
# ==============================================================================================================================
    ...
    final_df.to_excel('Characteristics_allocation_dh_run_17.03.22(2).xlsx', index = False)
