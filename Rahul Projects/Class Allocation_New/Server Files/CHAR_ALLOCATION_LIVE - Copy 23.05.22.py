...
def char_allocation(clause_data,property_cndtn_data,class_data, desc_cls_file):
    ...
    #-------------------------------------------------------------------------------------------------------------------
        ...
        # print(name)
        # print(val)
        # print('uom"s', final_df['uom'])
        # print('first uom of final df ', final_df['uom'][0])
        # print(final_df['uom'][0] == '')
        # print('type of first final uom', type(final_df['uom'][0]))
        # final_df['uom'].fillna('N/A', inplace = True)

        final_df['uom'] = final_df['uom'].replace('', 'N/A')
        # print(final_df['uom'])
        final_df.to_excel('output_char_extraction_spir_21.04.22.xlsx', index = False)
