    ...
    def uom_val(des):
        ...
        for i in UOM['RULE_UOM'].unique():
            if re.search(r'\b([0-9]{1,4}|[0-9]{1,4}[.][0-9]{1,3})(\s|\S|)' + '{}''{}'.format(i,r'\b'),str(des)):
                ...
                val2 = re.sub('([0-9]{1,3}[X][0-9]{1,3}|[0-9]{1,3}[\/][0-9]{1,3}|[0-9]{1,3})(\s|)','',str(val1)).strip()
            ...
            elif re.search(r'\b([0-9]{1,4}[\/][0-9]{1,4}|[0-9]{1,4}[X][0-9]{1,4}|[0-9]{1,4}|[0-9]{1,4}[.][0-9]{1,3})(\s|\S|)' + 
                        '{}'.format(i),str(des)):
                val = (re.search(r'\b([0-9]{1,4}[\/][0-9]{1,4}|[0-9]{1,4}[X][0-9]{1,4}|[0-9]{1,4}|[0-9]{1,4}[.][0-9]{1,3})(\s|\S|)' + 
