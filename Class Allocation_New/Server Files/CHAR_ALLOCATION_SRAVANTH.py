...
def char_allocation(clause_data,property_cndtn_data,class_data,UOM,UOM1, desc_cls_file):
...
# ==============================================================================================================================
    ...
    final_df.to_excel('output_char_extraction_spir_exclude_data_10.03.22.xlsx', index = False)
