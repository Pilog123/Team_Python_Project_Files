...
class DatabaseConnection:
    ...
    def accessNameValidation(self) -> str:
        ...
        with open(r'C:\Users\Administrator\PythonDeployment\Class Allocation_New\Server Files\isk_connectit\jython_DB.properties', 'r') as fp:
            countdata = 0
            fdata = fp.readlines()
            for i in fdata:
    ...
    def getDBProperties(self):
        with open(r'C:\Users\Administrator\PythonDeployment\Class Allocation_New\Server Files\isk_connectit\jython_DB.properties', 'rb') as fp:
            db_dict = {}
